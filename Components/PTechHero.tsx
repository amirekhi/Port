...
const PTechHero = () => {
  return (
    <div className="pb-20 pt-36 w-[80vw] mx-auto relative max-md:pt-16  max-md:pb-10 max-md:h-[400px] ">
     ...
     <GridBackgroundDemo/>
      ...
      <div className="flex justify-center relative my-20 z-10">
        <div className="max-w-[89vw] md:max-w-2xl lg:max-w-[60vw] flex flex-col items-center justify-center">
          <p className="uppercase tracking-widest text-sm font-semibold text-center text-blue-100 max-w-80 light:text-[#3B3B3B]">
