          ...
          >
            ...
            <div className="flex flex-col lg:flex-row items-start lg:items-center p-4 md:p-5 lg:p-10 gap-3">
              ...
              <div className="lg:ms-5">
                <h1 className="text-right text-sm md:text-lg lg:text-2xl font-bold leading-snug">
                  {card.title}
                </h1>
                <p className="text-right text-white-100 mt-2 text-xs md:text-sm lg:text-base font-semibold leading-relaxed">
                  {card.desc}
                </p>
              </div>
            </div>
