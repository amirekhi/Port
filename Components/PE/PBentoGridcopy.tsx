  ...
  return (
    <div
      className={cn(
        ...
        "grid grid-cols-1 md:grid-cols-6 lg:grid-cols-5 md:grid-row-7 gap-4 lg:gap-8 mx-auto w-[70vw]",
        className
      )}
    >
      {children}
    ...
    >
      ...
      <div className={`${id === 6 && "flex justify-center"} h-full`}>
        ...
        >
          ...
          <div className="font-sans font-extralight w-[450px] md:text-xs text-right lg:text-base text-sm text-[#C1C2D3] z-10">
            {description}
          </div>
          {/* add text-3xl max-w-96 , remove text-neutral-600 dark:text-neutral-300*/}
          {/* remove mb-2 mt-2 */}
          <div
            className={`font-sans text-lg lg:text-3xl max-w-96 font-bold z-10 text-right`}
          >
            {title}
          </div>
          ...
          {id === 6 && (
            <div className="mt-5 relative">
              ...
              <MagicButton
                title={copied ? "!ایمیل کپی شد " : "!ایمیل من را کپی کنید"}
                icon={<IoCopyOutline />}
                position="left"
