        ...
        >
          {projects.map((item) => {
            ...
            return (
              <div
                key={item._id}
                className="group relative snap-center shrink-0 sm:w-96 w-[80vw] flex flex-col justify-between rounded-3xl overflow-hidden
                  ...
                  >
                    <div className="flex items-center">
                      {item.iconLists.map((icon: string, index: number) => (
                        <div
                          key={index}
                          className="border border-black/10 dark:border-purple-500/20
