        ...
        {projects.map((item: any) => (
          ...
          >
            ...
            <button
              ...
              className="absolute top-[-20] md:top-0 right-0 bg-blue-500 cursor-pointer hover:bg-blue-600 text-white rounded-full w-8 h-8 flex items-center justify-center"
              title="Edit project"
            >
              ✎
            </button>
            ...
            <button
              ...
              disabled={isPending}
              className="absolute top-[-20]  md:top-0 right-12 bg-red-500 cursor-pointer hover:bg-red-600 text-white rounded-full w-8 h-8 flex items-center justify-center"
