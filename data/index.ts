...
export const expCards = [
  {
    ...
    imgPath: "/experience/js.png",
    logoPath: "/experience/js.png",
  ...
  },
  {
    ...
    imgPath: "/experience/react.png",
    logoPath: "/experience/react.png",
    title: "React Environment",
    date: "2021 - 2022",
    responsibilities: [
      "React , Vite , firebase , three.js , Express , MERN , MongoDb , Node.js",
      "SPA , PWA , CCNA Voice",
      "learning Performance Optimizations of Frontend Applications",
    ],
  },
  {
    review: "Adrian’s work on Appwrite’s mobile app brought a high level of quality and efficiency. He delivered solutions that enhanced our mobile experience & meet our product goals.",
    imgPath: "/experience/next2.jpg",
    logoPath: "/experience/next2.jpg",
    title: "Js frameworks",
    date: "2022 - 2023",
    responsibilities: [
      "Next js , SEO , Getting deeper in reacts architecture",
      "SQLserver ,",
  ...
  {
    review: "Adrian’s work on Appwrite’s mobile app brought a high level of quality and efficiency. He delivered solutions that enhanced our mobile experience & meet our product goals.",
    imgPath: "/experience/dotnet.png",
    logoPath: "/experience/dotnet.png",
    title: ".NET",
    date: "2023 - 2024",
    responsibilities: [
...
export const PexpCards = [
  ...
  },
  {
    ...
    responsibilities: [
      "React , Vite , firebase , three.js , Express , MERN , MongoDb , Node.js",
      "SPA , PWA , CCNA Voice",
      "یادگیری اصول  بهینه سازیه فرانت اند ",
    ],
  },
  {
    review:"همکاری با امیر یک تجربه فوق‌العاده بود. حرفه‌ای‌گری، سرعت عمل و تعهد او به ارائه نتایجی بی‌نظیر در طول پروژه ما کاملاً مشهود بود. اشتیاق امیر به تمام جنبه‌های توسعه واقعاً چشمگیر است. اگر به دنبال ارتقای وب‌سایت و برند خود هستید، امیر شریک ایده‌آلی برای شماست.",
    ...
    responsibilities: [
      ...
      "  Next js , SEO ",
      "ساخت اپلیکیشن های مختلف از اول تا اخر با استک های مختلف اپتیمایز شده برای سعو . ساخت  سیستم های احراز هویت ( جی دابلیو تی )",
    ],
  },
  {
    review: "همکاری با امیر یک تجربه فوق‌العاده بود. حرفه‌ای‌گری، سرعت عمل و تعهد او به ارائه نتایجی بی‌نظیر در طول پروژه ما کاملاً مشهود بود. اشتیاق امیر به تمام جنبه‌های توسعه واقعاً چشمگیر است. اگر به دنبال ارتقای وب‌سایت و برند خود هستید، امیر شریک ایده‌آلی برای شماست.",
